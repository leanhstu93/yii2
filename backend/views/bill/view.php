        ...
        <div class="row">
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover table-striped table-danhsach table-cart">
                            <tbody><tr>
                                <td width="140">Người mua</td>
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover table-striped table-danhsach table-cart">
                            <tbody><tr>
                                <td width="140">Người mua</td>
                                <td>: <?= $model->receive_fullname ?></td>
                            </tr>
                            <tr>
                                <td width="140">Email</td>
                                <td>: <a href="mailto:<?= $model->receive_email ?>"><?= $model->receive_email ?></a></td>
                            </tr>
                            <tr>
                                <td width="140">Điện thoại</td>
                                <td>: <a href="tel:<?= $model->receive_phone ?>"><?= $model->receive_phone ?></a></td>
                            </tr>
                            <tr>
                                <td width="140">Địa chỉ</td>
                                <td>: <?= $model->receive_address ?></td>
                            </tr>
                            </tbody></table>
                    </div>
                </div>
            ...
            <div class="col-xxl-12 col-lg-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover table-striped table-danhsach table-cart table-new-ver">
                            <tbody><tr>
                                <th>Sản phẩm</th>
                                <th class="w100 text-center">Số lượng</th>
                                <th class="w200 text-center">Đơn giá</th>
                                <th class="w200 tl">Thành tiền</th>
                            </tr>
                            <tr>
                                <td>
                                    <img width="100px" src="/<?= $billDetail->image ?>" class="img_thumb">
                                    <div class="name">
                                        <?= $billDetail->name ?>
                                    </div>
                                    <div class="dv-tndh-ad">
                                    </div>
                                </td>
                                <td class="text-center">
                                    <?= $billDetail->quantity ?>                                        </td>
                                <td class="text-center">
                                    <?= number_format($billDetail->price) ?>đ
                                </td>
                                <td class="align-middle" align="right">
                                    <?= number_format($billDetail->price*$billDetail->quantity) ?>đ
                                </td>
                            </tr>

                            <tr>
                                <td colspan="3" align="right">Tạm tính</td>
                                <td align="right"><strong><?= number_format($model->total_cost) ?>đ</strong></td>
                            </tr>
                            <tr>
                                <td colspan="3" align="right">Tổng cộng</td>
                                <td align="right">
                                    <span style="color: red;font-size: 18px !important;"><?= number_format($model->total_cost) ?>đ</span>
                                </td>
                            </tr>
                            </tbody></table>
                    </div>
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Heading With Tag
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-briefcase" aria-hidden="true"></i>Heading Icon</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="panel-actions panel-actions-keep">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-bullet dropdown-menu-right" aria-labelledby="examplePanelDropdown" role="menu">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0)" role="menuitem"><i class="icon wb-share" aria-hidden="true"></i> Share</a>
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel nav-tabs-horizontal" data-plugin="tabs">
                    ...
                    <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#exampleTopHome" aria-controls="exampleTopHome" role="tab" aria-expanded="true"><i class="icon wb-plugin" aria-hidden="true"></i>Home</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exampleTopComponents" aria-controls="exampleTopComponents" role="tab"><i class="icon wb-user" aria-hidden="true"></i>Components</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exampleTopCss" aria-controls="exampleTopCss" role="tab"><i class="icon wb-tag" aria-hidden="true"></i>CSS</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exampleTopJavascript" aria-controls="exampleTopJavascript" role="tab"><i class="icon wb-cloud" aria-hidden="true"></i>JavaScript</a></li>
                        <li class="dropdown nav-item" style="display: none;">
                            ...
                            <div class="dropdown-menu" role="menu">
                                ...
                                <a class="dropdown-item" data-toggle="tab" href="#exampleTopCss" aria-controls="exampleTopCss" role="tab"><i class="icon wb-tag" aria-hidden="true"></i>CSS</a>
                                <a class="dropdown-item" data-toggle="tab" href="#exampleTopJavascript" aria-controls="exampleTopJavascript" role="tab"><i class="icon wb-cloud" aria-hidden="true"></i>JavaScript</a>
                            </div>
                        </li>
                    </ul>
                    <div class="panel-body">
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel nav-tabs-horizontal" data-plugin="tabs">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bottom nav-tabs-line dropup" role="tablist">
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#exampleBottomHome" aria-controls="exampleBottomHome" role="tab"><i class="icon wb-plugin" aria-hidden="true"></i>Home</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exampleBottomComponents" aria-controls="exampleBottomComponents" role="tab"><i class="icon wb-user" aria-hidden="true"></i>Components</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exampleBottomCss" aria-controls="exampleBottomCss" role="tab"><i class="icon wb-tag" aria-hidden="true"></i>CSS</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#exampleBottomJavascript" aria-controls="exampleBottomJavascript" role="tab"><i class="icon wb-cloud" aria-hidden="true"></i>JavaScript</a></li>
                        <li class="nav-item dropdown" style="display: none;">
                            <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="#" aria-expanded="false" aria-haspopup="true">Dropdown</a>
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" data-toggle="tab" href="#exampleBottomHome" aria-controls="exampleTopHome" role="tab"><i class="icon wb-plugin" aria-hidden="true"></i>Home</a>
                                <a class="dropdown-item" data-toggle="tab" href="#exampleBottomComponents" aria-controls="exampleTopComponents" role="tab"><i class="icon wb-user" aria-hidden="true"></i>Components</a>
                                <a class="dropdown-item" data-toggle="tab" href="#exampleBottomCss" aria-controls="exampleTopCss" role="tab"><i class="icon wb-tag" aria-hidden="true"></i>CSS</a>
                                <a class="dropdown-item" data-toggle="tab" href="#exampleBottomJavascript" aria-controls="exampleTopJavascript" role="tab"><i class="icon wb-cloud" aria-hidden="true"></i>JavaScript</a>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div class="progress progress-sm mt-10" data-goal="25" data-plugin="progress">
                            <div class="progress-bar progress-bar-success" aria-valuemin="15" aria-valuemax="115" aria-valuenow="25" role="progressbar" style="width: 10%;"></div>
                        </div>
                        <div class="progress progress-sm" data-goal="-40" data-plugin="progress">
                            <div class="progress-bar progress-bar-warning" aria-valuemin="-100" aria-valuemax="0" aria-valuenow="-40" role="progressbar" style="width: 60%;"></div>
                        </div>
                        <div class="progress progress-sm" data-goal="80" data-plugin="progress">
                            <div class="progress-bar progress-bar-danger" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80" role="progressbar" style="width: 80%;"></div>
                        </div>
                        <div class="progress progress-sm" data-goal="30" data-plugin="progress">
                            <div class="progress-bar progress-bar-success" aria-valuemin="0" aria-valuemax="100" aria-valuenow="30" role="progressbar" style="width: 30%;"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <div class="panel-actions">
                            <div class="progress progress-xs w-150 w-lg-100">
            ...
            <div class="col-xxl-4 col-lg-6">
                <!-- Example Panel With Tags And Tag-pills -->
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Panel With Tags And Tag-pills</h3>
                        <div class="panel-actions panel-actions-keep">
                ...
                <!-- End Example Panel With Tags And Tag-pills -->
            </div>
            ...
            <div class="col-xxl-4 col-lg-6">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        ...
                        <div class="panel-actions panel-actions-keep">
                            <input type="checkbox" data-plugin="switchery" data-size="small" checked="" data-switchery="true" style="display: none;"><span class="switchery switchery-small" style="background-color: rgb(62, 142, 247); border-color: rgb(62, 142, 247); box-shadow: rgb(62, 142, 247) 0px 0px 0px 11.5px inset; transition: border 0.4s ease 0s, box-shadow 0.4s ease 0s, background-color 1.2s ease 0s;"><small style="left: 12px; background-color: rgb(255, 255, 255); transition: background-color 0.4s ease 0s, left 0.2s ease 0s;"></small></span>
                        </div>
                    </div>
                    <div class="panel-body">
            ...
            <!-- Example Panel-heading with tabs -->
            <div class="col-lg-6">
                <div class="panel nav-tabs-horizontal nav-tabs-inverse" data-plugin="tabs">
                    <div class="panel-heading panel-heading-tab">
                        <ul class="nav nav-tabs nav-tabs-solid" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#panelTab1" aria-controls="panelTab1" role="tab" aria-expanded="true">tab1</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#panelTab2" aria-controls="panelTab2" role="tab">tab2</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#panelTab3" aria-controls="panelTab3" role="tab">tab3</a></li>
                        </ul>
                    </div>
                    <div class="panel-body pt-20">
                        <div class="tab-content">
                            <div class="tab-pane active" id="panelTab1" role="tabpanel">
                                <h4>Tabs In Heading</h4>
                                Conturbamur senectutem saepti statua, putanda homini acuti dialectica levamur urbanitas
                                animadversionem mala se depulsa, magis nihilo efficeret tenetur
                                cives gloriae concursio defendit conscientiam nascuntur, refugiendi
                                defendit falsi platonem paranda metum iustioribus cognita robustus,
                ...
                <div class="panel nav-tabs-horizontal" data-plugin="tabs">
                    <div class="panel-heading p-30 pb-0 pt-10">
                        <ul class="nav nav-pills" role="tablist">
                            <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#cardTab1" aria-controls="cardTab1" role="tab" aria-expanded="true">tab0</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#cardTab2" aria-controls="cardTab2" role="tab">tab1</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#cardTab3" aria-controls="cardTab3" role="tab">tab2</a></li>
                        </ul>
                    </div>
                    <div class="panel-body">
                        <div class="tab-content">
            ...
            <!-- End Example Panel-heading with tabs -->
            ...
            <div class="col-lg-6">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body h-250 scrollable scrollable-shadow is-enabled scrollable-vertical" data-plugin="scrollable" data-skin="scrollable-shadow">
                        <div data-role="container" class="scrollable-container" style="height: 220px; width: 610px;">
                        ...
                        <div class="scrollable-bar scrollable-bar-vertical scrollable-bar-hide" draggable="false"><div class="scrollable-bar-handle" style="height: 130.108px;"></div></div></div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body container-fluid h-250 scrollable scrollable-shadow is-enabled scrollable-horizontal" data-show-on-hover="false" data-direction="horizontal" data-skin="scrollable-shadow" data-plugin="scrollable">
                        <div data-role="container" class="scrollable-container" style="height: 267px;">
                            <div data-role="content" style="width: 1400px; height: 250px;" class="scrollable-content">
                                <div class="row">
                                    <div class="col-md-3">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent
                        ...
                        <div class="scrollable-bar scrollable-bar-horizontal" draggable="false"><div class="scrollable-bar-handle" style="width: 200.77px;"></div></div></div>
                </div>
